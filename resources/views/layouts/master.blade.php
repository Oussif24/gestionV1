...
<body>
    <header>
        ...
        <nav>
            ...
            <button class="btn" onclick="location.href='{{ route('register', ['role' => 'client']) }}'"><i class="fa fa-user-plus"></i> S'inscrire</button>
            <div class="dropdown">
                <button class="dropbtn"><i class="fa fa-sign-in"></i> Se connecter</button>
                <div class="dropdown-content">
                    <a href="{{ route('login', ['role' => 'admin']) }}">Admin</a>
                    <a href="{{ route('login', ['role' => 'respo']) }}">Responsable</a>
                    <a href="{{ route('login', ['role' => 'client']) }}">Client</a>
                </div>
            </div>
